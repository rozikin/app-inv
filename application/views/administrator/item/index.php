                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= base_url(); ?>Controller_Item/print" class="btn btn-info btn-sm"><i class="fas fa-exprot"></i> View Barcode</a>



                        </div>
                        <div class="col-5 mt-3">
                            <form method="POST" action="<?= base_url('Controller_Item/import') ?>" enctype="multipart/form-data">
